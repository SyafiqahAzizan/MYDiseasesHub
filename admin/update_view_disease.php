  ...
  ?>
   <tr align="left" bgcolor="">
    ...
    ?>
        ...
        <td width="5%" align="center"><a class="one" href="update_more_disease.php?service_id=<?php echo $row['service_id'];?>">Edit</a></td>
        <td width="5%" align="center"><a class="one" href="delete_user.php?service_id=<?php echo $row['service_id'];?>">Delete</a></td>
      </tr> 
      <?php 
       $color="2";}
     else{
